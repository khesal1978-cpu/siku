    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      >
        ...
        <div className="relative h-full flex items-end p-6 pb-12">
          <div>
            <h1 className="text-3xl font-bold font-['Poppins'] text-foreground mb-1 drop-shadow-lg">
              Mining Dashboard
            </h1>
            <p className="text-sm text-muted-foreground drop-shadow">Keep mining to earn more rewards</p>
          </div>
        </div>
      </div>
